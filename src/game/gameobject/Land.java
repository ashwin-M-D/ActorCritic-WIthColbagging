...
public class Land {
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		URL land1URL = this.getClass().getResource("land1.png");
		URL land2URL = this.getClass().getResource("land2.png");
		URL land3URL = this.getClass().getResource("land3.png");
		try {
			land1 = ImageIO.read(land1URL);
			land2 = ImageIO.read(land2URL);
			land3 = ImageIO.read(land3URL);
		} catch (IOException e) {
			e.printStackTrace();
		}
